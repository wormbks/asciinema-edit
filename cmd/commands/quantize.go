...
func ParseQuantizeRange(input string) (res cast.QuantizeRange, err error) {
...
func parseQuantizeRanges(inputs []string) (ranges []cast.QuantizeRange, err error) {
	ranges = make([]cast.QuantizeRange, 0)
